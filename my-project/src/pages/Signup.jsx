                ...
                <div className="relative p-10 flex flex-col items-center">
                    <div className="mb-8 relative">
                        ...
                        <div className="relative w-16 h-16 flex items-center justify-center bg-white rounded-2xl shadow-xl border border-white/20 transform hover:rotate-6 transition-transform duration-500">
                            <UserPlus className="w-8 h-8 text-purple-600 drop-shadow-md" />
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="w-full space-y-4">
                        <div className="group relative">
                            <div className="absolute -inset-[1px] bg-gradient-to-r from-purple-500/50 to-blue-500/50 rounded-2xl blur-sm opacity-0 group-focus-within:opacity-100 transition duration-500"></div>
                            <div className="relative flex items-center">
                                <Mail className="absolute left-4 w-5 h-5 text-zinc-500 group-focus-within:text-purple-400 transition-colors" />
                                <input
                                    type="email"
                                    name="email"
                                    required
                        ...
                        <div className="group relative">
                            <div className="absolute -inset-[1px] bg-gradient-to-r from-purple-500/50 to-blue-500/50 rounded-2xl blur-sm opacity-0 group-focus-within:opacity-100 transition duration-500"></div>
                            <div className="relative flex items-center">
                                <Lock className="absolute left-4 w-5 h-5 text-zinc-500 group-focus-within:text-blue-400 transition-colors" />
                                <input
                                    type="password"
                    ...
                    <div className="w-full flex items-center gap-4 my-8">
                        ...
                        <span className="text-zinc-600 text-[10px] font-black uppercase tracking-[0.3em]">Sign up with</span>
                        <div className="h-[1px] flex-1 bg-white/10"></div>
                    </div>
