...
import { Mail, Github, UserPlus, ArrowRight, Lock, Loader2, AlertCircle, CheckCircle2, Eye, EyeOff } from "lucide-react";
...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                setStatus({ loading: false, type: "success", message: "Account created! Redirecting to login..." });
        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden font-sans"
            ...
            >
                ...
                <div className="relative p-8 md:p-10 flex flex-col items-center">
                    ...
                    >
                        <div className="absolute inset-0 blur-2xl rounded-full" style={{ background: 'rgba(139,92,246,0.3)' }} />
                        <div className="relative w-16 h-16 flex items-center justify-center rounded-2xl shadow-xl hover:rotate-6 transition-transform duration-500"
                            style={{ background: 'linear-gradient(135deg, #8b5cf6, #6366f1, #3b82f6)', boxShadow: '0 8px 32px rgba(139,92,246,0.3)' }}>
                    ...
                    <h1 className="text-3xl md:text-4xl font-extrabold mb-2 tracking-tight text-center" style={{ color: 'var(--text-heading)' }}>
                        Create{" "}
                        <span style={{
                            backgroundImage: 'linear-gradient(135deg, #a78bfa, #818cf8, #60a5fa)',
                    ...
                    <p className="text-slate-500 text-center text-sm mb-6 font-medium max-w-[240px]">
                        Join the future of creative AI interaction today.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="w-full space-y-4">
                        <div className="group relative">
                            ...
                            <div className="relative flex items-center">
                                <Mail className="absolute left-4 w-5 h-5 text-slate-600 group-focus-within:text-violet-400 transition-colors" />
                                <input
                                    type="email"
                                    name="email"
                                    required
                        ...
                        <div className="group relative">
                            ...
                            <div className="relative flex items-center">
                                <Lock className="absolute left-4 w-5 h-5 text-slate-600 group-focus-within:text-blue-400 transition-colors" />
                                <input
                        ...
                        >
                            <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, #8b5cf6, #6366f1, #3b82f6)' }} />
                    ...
                    <div className="w-full flex items-center gap-4 my-7">
                        ...
                        <span className="text-slate-600 text-[10px] font-bold uppercase tracking-[0.3em]">Sign up with</span>
                        <div className="h-px flex-1" style={{ background: 'rgba(148,163,184,0.08)' }} />
                    </div>
